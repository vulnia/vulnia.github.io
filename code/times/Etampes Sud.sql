SELECT DISTINCT st_A.arrival_time, st_B.arrival_time, st_C.arrival_time, st_D.arrival_time, st_E.arrival_time, st_F.arrival_time, st_G.arrival_time, t.trip_headsign
...
AND t.trip_headsign IN ("ELBA")

ORDER BY st_A.arrival_time;
...
SELECT
t.trip_headsign,
st_G.departure_time Ad1,
st_F.departure_time Bd1,
st_E.departure_time Cd1,
st_D.departure_time Dd1,
st_C.departure_time Ed1,
st_B.departure_time Fd1,
st_A.departure_time Gd1
...
AND t.trip_headsign IN ("ELBA","DEBA","DEBO","BALI","JUJU","MONA","ROMI","LOLA")

UNION

SELECT
t.trip_headsign,
st_G.departure_time Ad2,
st_F.departure_time Bd2,
st_E.departure_time Cd2,
st_D.departure_time Dd2,
st_C.departure_time Ed2,
st_B.departure_time Fd2,
st_A.departure_time Gd2
...
ORDER BY COALESCE(Fd1,ADDTIME(Cd1,"0:10:0"))

INTO OUTFILE '/usr/local/mysql/mysql-files/bfm-sud.csv'
